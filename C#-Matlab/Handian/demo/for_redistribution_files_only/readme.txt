...
demo_overview.html - HTML overview documentation file for the generated component. It 
                     contains the requirements for accessing the component and for 
                     generating arguments using the MWArray class hierarchy.

demo.xml - This file contains the code comments for the demo component classes and 
                     ...
                     online documentation for the demo component.
